...
<head>
    ...
    <title>Recovolt Energy | Register</title>
    ...
    <main>
            <section class="reg_log">
                <div class="login_page" id="reg_form">
                    ...
                    <p>Get a free Ippssolar account</p>
                    <?php
                    ...
                    <form action="../controller/register.php" method="POST">
                        ...
                        <div class="data" id="reg_btn">
                            <button type="submit" name="register">Register <i class="fas fa-sign-in"></i></button>
                    ...
                    <div id="foot">
                        <p >&copy;<?php echo Date("Y");?> Recovolt Energy. All Rights Reserved.</p>
