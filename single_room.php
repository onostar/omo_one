            ...
            <div id="room_details">
                ...
                <div class="room_rules">
                    ...
                    <div class="check_in_out">
                        <div class="check_in">
                            <h5>Check In</h5>
                            <p>Check-in from 8:00am - anytime</p>
                            <p>Early check-in subject to availability</p>
                            <p>Minimum check-in age - 18</p>
                            <p>No smoking in the room</p>
                        </div>
                        <div class="check_out">
                            <h5>check-out</h5>
                            <p>Check-out before noon (12:00pm)</p>
                ...
                <div class="children">
                    ...
                    <p>Youngsters are welcome. Kids stay free! Youngsters stay free when utilizing existing sheet material; kids may not be qualified for free breakfast Rollaway/additional beds are accessible for ₦5,000 each day</p>
                </div>
            </div>
            <!-- other room types -->
            <div class="more_room_type">
